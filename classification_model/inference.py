...
# Class names.
class_names = ['agouti', 'bird_spec', 'coiban_agouti', 'collared_peccary', 'common_opossum', 'european_hare', 'great_tinamou', 'mouflon', 'ocelot', 'paca', 'red_brocket_deer', 'red_deer', 'red_fox', 'red_squirrel', 'roe_deer', 'spiny_rat', 'white-nosed_coati', 'white_tailed_deer', 'wild_boar', 'wood_mouse']
