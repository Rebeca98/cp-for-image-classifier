...
from conformal_classification.experiments import create_sizes_topk_table
...
if __name__ == "__main__":
    ...
    # experiment output
    experiment_name = f"topk_size_exp1-{config_file_name}"
    ...
    df = create_sizes_topk_table(models_info_dict, calibration_dataset_path, num_classes, alphas, predictors, lamdas, kregs,
