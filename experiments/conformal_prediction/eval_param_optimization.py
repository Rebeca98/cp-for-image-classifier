...
if __name__ == "__main__":
    ...
    # enables an automatic algorithm selection process within cuDNN
    ...
    # experiment results
    experiment_name = f"optim-parameters-exp1-{config_file_name}"
    ...
    df = create_evaluation_table(models_info_dict,calibration_dataset_path , num_classes, alphas, predictors, kreg, lamda,
