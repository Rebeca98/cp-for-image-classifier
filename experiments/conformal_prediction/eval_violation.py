...
from conformal_classification.experiments import create_violation_table
...
if __name__ == "__main__":
    ...
    # experiment output
    experiment_name = f"violation-exp1-{config_file_name}"
    output_experiment_path = os.path.join('output/conformal-alg', experiment_name) + ".csv"
    ...
    df = create_violation_table(models_info_dict, calibration_dataset_path, num_classes, total_conf, pct_cal, pct_val, alphas, randomized, bsz, image_size, num_trials, strata, pct_paramtune)
